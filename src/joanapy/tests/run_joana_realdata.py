...
path='/home/samerifar/joana/lymphoma/Julius/R_ABC_GCB/newJo/'+varPath
...
filename_assignment_matrix_gmt=path+kegg
#filename_terms = path+'/terms.txt'
filename_qvalues_first= path+typeInput+'RNAorg.txt'
filename_qvalues_second = path+typeInput+'Protorg.txt'
filename_missing_first = path+'missingRNA.txt'
filename_missing_second = path+'missingProt.txt'
filename_gene_ids = path+'geneSymbDegDepOrg.txt'
filename_qvalues_first_filtered = path+'qvalues_first_species_symptomatic_filtered.txt'
filename_qvalues_second_filtered = path+'qvalues_second_species_asymptomatic_filtered.txt'
filename_missing_first_filtered = path+'missing_first_species_symptomatic_filtered.txt'
filename_missing_second_filtered = path+'missing_second_species_asymptomatic_filtered.txt'
...
filename_terms = path+'Human_GOALL_with_GO_iea_March_01_2021_symbol_terms_utilization' +str(min_term_size)+'_'+ str(max_term_size)+'_'+ str(min_term_utilization)+'.txt'
filename_assignment_matrix = path+'Human_GOALL_with_GO_iea_March_01_2021_symbol_utilization'+ str(min_term_size)+'_'+ str(max_term_size)+'_'+ str(min_term_utilization)+'.txt'
